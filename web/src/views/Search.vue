<template>
    <div>
        ...
        <v-row justify="center">
            <v-col cols="4">
                <v-btn block rounded color="primary" @click="searchStars" :disabled="loading" :loading="loading">
                    <v-icon left>
                        mdi-magnify
                    </v-icon>
                    Search
    ...
    export default {
        ...
        methods: {
            searchStars() {
                ...
                this.axios.post('http://localhost:5000/search', params).then((response) => {
